...
import static com.modelsw.birdingviamic.Main.specieSelected;
...
public class NewNameDialog extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        specieName = (EditText) findViewById(R.id.species_text);
        specieName.setText ((CharSequence) Main.specieSelected );
        //specieName.setText((CharSequence) "XXXXXXXXXXXXXXXXX");
        specieName.setOnClickListener(this);
    }
...
/*
    ...
    private void loadSpinnerData() {
        ...
        // preposition to existing spec (found in Species BEFORE opening this NewNameDialog)
        spinner.setSelection(Main.specOffset);  // it is offset = 1
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.done_button: {
                ...
                Main.newRef = Main.specieRefSelected;
                setResult(1);
                finish();
                break;
            }
