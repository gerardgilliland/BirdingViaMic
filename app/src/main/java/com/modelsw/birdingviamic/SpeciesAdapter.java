            ...
            public void onClick(View v) {
                ...
                for (int i=0; i<SpeciesList.speciesDbLen; i++) {
                    if (SpeciesList.chk[i] == true) {
                        // save this in Main so the specie can be used in Songs Name
                        SpeciesList.selectedSpecies = i;
                        Main.specieRefSelected = Main.speciesRef[i];
                        Main.specOffset = i;
                        Main.specieSelected = SpeciesList.speciesCombined[i];
                        Log.d(TAG, "selectedSpecies:" + Main.specieSelected + " Ref:" + Main.specieRefSelected);
                    }
                }
